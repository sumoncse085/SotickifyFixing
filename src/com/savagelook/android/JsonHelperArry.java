...
public class JsonHelperArry {
	...
	public static JSONArray getJsonObjectFromUrl(String url, String authToken) throws MalformedURLException, JSONException, IOException 
	{
		return getJsonObjectFromUrl(url, 0, 0, authToken);
	}
	
	public static JSONArray getJsonObjectFromUrl(String url, int connectTimeout, int readTimeout, String authToken) throws MalformedURLException, JSONException, IOException 
	{
		return new JSONArray(getStringFromUrl(url, connectTimeout, readTimeout, authToken));
	}
