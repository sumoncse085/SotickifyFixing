...
public class UrlJsonAsyncTaskForArray extends AsyncTask<String, Void, JSONArray> {
	...
	public UrlJsonAsyncTaskForArray(Context context) {
		...
		progressDialog = ProgressDialog.show(
			...
			new DialogInterface.OnCancelListener() {	
				...
				public void onCancel(DialogInterface arg0) {
					UrlJsonAsyncTaskForArray.this.cancel(true);
				}
			}
		);
	}
	...
	protected JSONArray queryUrlForJson(String url) {
		...
		try {
			...
			json = JsonHelperArry.getJsonObjectFromUrl(url, this.timeoutConnect, this.timeoutRead, this.authToken);
